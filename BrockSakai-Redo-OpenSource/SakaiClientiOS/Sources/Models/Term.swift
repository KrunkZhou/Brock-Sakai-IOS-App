...
/// A model to represent individual semesters following the 
/// academic schedule
struct Term {
    private static let mapTerms: [Int: String] = [6: "FW",
                                                  1: "SP",
                                                  3: "SU"]
    private static let mapTermsR: [ String:Int] = ["FW":6,
                                                   "SP":1,
                                                   "SU":3]
    ...
    init(toParse: String?) {
        ...
        let term = String(dataArray[1])
        //print (String(year)+dataArray[0])
        //print (String(term)+dataArray[1])
        self.init(year: year,
                  termInt: Term.mapTermsR[term],
                  termString: term,
                  initString: toParse)
    }
